    ...
    <x-slot name="header">
        <div class="flex items-center gap-6 px-4">
            ...
            <div>
                ...
                <p class="text-[8px] text-indigo-500 font-black uppercase tracking-[0.4em] mt-1 italic">Arquitectura Premium</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="space-y-10">
                        <div>
                            ...
                            <input id="nombre" name="nombre" type="text" 
                                ...
                                placeholder="EJ: TECNOLOGÍA" required autofocus />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" name="descripcion" 
                                class="block w-full bg-white/5 border border-white/10 rounded-2xl text-white px-6 py-6 text-sm font-bold focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder-gray-800 italic h-40 resize-none"
                                placeholder="Describa el propósito de esta categoría..."></textarea>
                        </div>
                    </div>

                    <!-- Botonera -->
                    <div class="mt-20 pt-10 border-t border-white/5 flex items-center justify-end gap-10">
                        <a href="{{ route('categoria.index') }}" class="text-[9px] text-gray-500 hover:text-white transition-colors font-black uppercase tracking-widest italic">Descartar</a>
                        <button type="submit" class="px-14 py-5 bg-white text-black rounded-2xl font-black text-[9px] uppercase tracking-widest shadow-xl hover:bg-white/90 transition-all transform hover:scale-105 active:scale-95">
